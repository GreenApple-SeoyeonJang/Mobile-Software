...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void busLocation() {
        ...
        if(a == 1){
            strUrl = "http://ws.bus.go.kr/api/rest/buspos/getBusPosByRtid?ServiceKey=SbHekl3v7zvP3o9hQVNwlxaXAvaW0QFDcEq7oMqGhqpKQw%2FkVWupRvH8kKiXlkcABIq%2F1sAaPTgefidYWqntKA%3D%3D&busRouteId=100100596";
            new DownloadWebpageTask().execute(strUrl);
        }
        else if(a == 2){
            strUrl = "http://ws.bus.go.kr/api/rest/buspos/getBusPosByRtid?ServiceKey=SbHekl3v7zvP3o9hQVNwlxaXAvaW0QFDcEq7oMqGhqpKQw%2FkVWupRvH8kKiXlkcABIq%2F1sAaPTgefidYWqntKA%3D%3D&busRouteId=100100522";
            new DownloadWebpageTask().execute(strUrl);
        }
        else if(a == 3){
            strUrl = "http://ws.bus.go.kr/api/rest/buspos/getBusPosByRtid?ServiceKey=SbHekl3v7zvP3o9hQVNwlxaXAvaW0QFDcEq7oMqGhqpKQw%2FkVWupRvH8kKiXlkcABIq%2F1sAaPTgefidYWqntKA%3D%3D&busRouteId=100100537";
            new DownloadWebpageTask().execute(strUrl);
        }
